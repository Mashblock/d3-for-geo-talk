...
},{"d3-color":9}],11:[function(require,module,exports){
...
},{"d3-interpolate":10}],12:[function(require,module,exports){
...
var NZMap = require('./_demos/nz_map'),
...
},{"./_demos/berlin":15,"./_demos/berlin_population":16,"./_demos/nz_map":17,"./_demos/points_linear":18,"./_demos/points_projection":19,"./_demos/write_list":20}],15:[function(require,module,exports){
'use strict';
...
var Berlin = function () {
  _createClass(Berlin, null, [{
    key: 'draw',
    value: function draw(el) {
      var instance = new Berlin(el);
  ...
  _createClass(Berlin, [{
    ...
    value: function fetch() {
      ...
      return new Promise(function (resolve, reject) {
        d3.json("/data/berlin_population.geojson", function (error, data) {
    ...
    value: function render() {
      var projection = d3.geoMercator().fitSize([300, 300], this.geojson);
      var path = d3.geoPath().projection(projection);

      var neighborhoods = this.svg.selectAll("path.land").data(this.geojson.features);
      neighborhoods.enter().append("path").attr("class", "land").attr("d", path);
    }
  }]);
...
},{"d3":12,"d3-scale-chromatic":11}],16:[function(require,module,exports){
"use strict";
...
var BerlinPopulation = function () {
  _createClass(BerlinPopulation, null, [{
    key: "draw",
    value: function draw(el) {
  ...
  function BerlinPopulation(el) {
    _classCallCheck(this, BerlinPopulation);

    this.svg = d3.select(el).append("svg").attr("width", 300).attr("height", 300);;
    this.colorScale = d3.scaleQuantile().range(["#f0f9e8", "#bae4bc", "#7bccc4", "#43a2ca", "#0868ac"]);
  }

  _createClass(BerlinPopulation, [{
    key: "fetch",
    value: function fetch() {
      var _this = this;
    ...
    value: function render() {
      ...
      this.colorScale.domain(this.geojson.features.map(function (d) {
        return d.properties.population_total;
      }));

      var neighborhoods = this.svg.selectAll("path.land").data(this.geojson.features);
      neighborhoods.enter().append("path").attr("class", "land").attr("d", path).attr("fill", function (d) {
        return _this2.colorScale(d.properties.population_total);
      }).append("title").text(function (d) {
        return d.properties.name + " - " + d.properties.population_total;
      });
    }
  }]);

  return BerlinPopulation;
}();

module.exports = BerlinPopulation;

},{"d3":12}],17:[function(require,module,exports){
'use strict';
...
var NZMap = function () {
  _createClass(NZMap, null, [{
    key: 'draw',
    value: function draw(el) {
      var instance = new NZMap(el);
      instance.fetch().then(function () {
        return instance.render();
      });
    }
  ...
  _createClass(NZMap, [{
    ...
    value: function fetch() {
      ...
      return new Promise(function (resolve, reject) {
        d3.json("/data/nz-coastline.topojson", function (error, data) {
          if (error) return reject(error);
          _this.geojson = topojson.feature(data, data.objects["nz-coastline"]);
          resolve();
        });
      });
    }
    ...
    value: function render() {
      ...
      this.svg.insert("path", ".graticule").datum(this.geojson).attr("class", "land").attr("d", path);
    }
  }]);
...
},{"d3":12,"topojson":13}],18:[function(require,module,exports){
"use strict";
...
var PointsLinear = function () {
  _createClass(PointsLinear, null, [{
    key: "draw",
    value: function draw(el) {
  ...
  function PointsLinear(el) {
    _classCallCheck(this, PointsLinear);

    this.svg = d3.select(el).append("svg").attr("width", 300).attr("height", 300);
  }

  _createClass(PointsLinear, [{
    key: "render",
    value: function render() {
      var points = [[52.529911, 13.410728], [52.526772, 13.407635], [52.524434, 13.406601], [52.501944, 13.431986], [52.500799, 13.419489], [52.529528, 13.401792]];

      var xScale = d3.scaleLinear().domain([13.40, 13.44]).range([5, 295]);
      var yScale = d3.scaleLinear().domain([52.50, 52.54]).range([295, 5]);

      var points = this.svg.selectAll("circle.point").data(points);
...
},{"d3":12}],19:[function(require,module,exports){
"use strict";
...
var PointsProjection = function () {
  _createClass(PointsProjection, null, [{
    key: "draw",
    value: function draw(el) {
  ...
  function PointsProjection(el) {
    _classCallCheck(this, PointsProjection);

    var svg = d3.select(el).append("svg").attr("width", 300).attr("height", 300);
    this.paper = svg.append("g").attr("transform", "translate(10, 10)");
  }

  _createClass(PointsProjection, [{
    key: "fetch",
    value: function fetch() {
      var _this = this;

      return new Promise(function (resolve, reject) {
        d3.json("/data/cafes.geojson", function (error, data) {
          if (error) return reject(error);
          _this.geojson = data;
          resolve();
        });
    ...
    key: "render",
    value: function render() {
      var projection = d3.geoMercator().fitSize([280, 280], this.geojson);
      var path = d3.geoPath().projection(projection);

      var points = this.paper.selectAll("path.point").data(this.geojson.features);

      points.enter().append("path").attr("class", "point").attr("d", path);
    }
  }]);
...
},{"d3":12}],20:[function(require,module,exports){
"use strict";

var d3 = require("d3");

var writeList = function writeList(list) {
  var ul = d3.select("ul.list");

  var items = ul.selectAll("li").data(list);

  // Add new elements.
  items.enter().append("li").text(function (item) {
    return item;
  });
...
},{"d3":12}],21:[function(require,module,exports){
'use strict';
...
var deck = bespoke.from('#presentation', [classes(), keys(), backdrop(), hash(), bullets('.bullet'), scale(), voltaire()]);

Demos.start();

},{"./_demos":14,"bespoke":8,"bespoke-backdrop":1,"bespoke-bullets":2,"bespoke-classes":3,"bespoke-hash":4,"bespoke-keys":5,"bespoke-scale":6,"bespoke-theme-voltaire":7}]},{},[21]);
